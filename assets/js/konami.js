...
class KonamiCode {
    ...
    handleKeyboardInput(keyCode) {
        ...
        // Check if this key matches the next expected key in the sequence
        const expectedKey = this.sequence[this.currentSequence.length];
        ...
        if (keyCode === expectedKey) {
            ...
            // But check if this key is the start of a new sequence
            if (keyCode === this.sequence[0]) {
                this.currentSequence.push(keyCode);
            }
        }
    }
